...
namespace _Framework.MarchingCubes
{
	public static class LookupTables
	{
		...
		public static readonly int[][] CubeConfigurations = new int[][]
		{
			...
			new int[] { 6, 7, 8, 8, 10, 6, 4, 5, 10, 10, 8, 4 },
			...
			new int[] { 3, 11, 6, 6, 5, 3, 10, 2, 3, 3, 5, 10 },
			new int[] { 1, 8, 3, 9, 8, 1, 5, 10, 6 },
			new int[] { 0, 1, 10, 10, 6, 0, 5, 9, 0, 0, 6, 5 },
			...
			new int[] { 5, 6, 11, 11, 9, 5, 11, 7, 4, 4, 9, 11 },
			...
			new int[] { 2, 11, 7, 7, 1, 2, 7, 6, 10, 10, 1, 7 },
			...
			new int[] { 11, 3, 0, 0, 6, 11, 0, 8, 7, 7, 6, 0 },
			new int[] { 11, 7, 6 },
			...
			new int[] { 2, 10, 5, 5, 4, 2, 9, 1, 2, 2, 4, 9 },
			...
			new int[] { 0, 5, 4, 1, 5, 0 },
			new int[] { 8, 3, 5, 5, 4, 8, 3, 0, 9, 9, 5, 3 },
			new int[] { 5, 4, 9 },
			...
			new int[] { 7, 11, 2, 2, 4, 7, 2, 3, 8, 8, 4, 2 },
			new int[] { 9, 4, 1, 4, 7, 1, 7, 3, 1 },
			new int[] { 8, 0, 1, 1, 7, 8, 1, 9, 4, 4, 7, 1 },
			new int[] { 3, 4, 7, 0, 4, 3 },
			new int[] { 7, 8, 4 },
			...
			new int[] { 8, 3, 2, 2, 10, 8, 1, 0, 8, 8, 10, 1 },
			new int[] { 2, 10, 1 },
			new int[] { 2, 1, 11, 1, 9, 11, 9, 8, 11 },
			new int[] { 11, 2, 1, 1, 9, 11, 0, 3, 11, 11, 9, 0 },
